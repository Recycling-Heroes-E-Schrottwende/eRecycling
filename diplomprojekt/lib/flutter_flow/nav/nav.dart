      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'List13PropertyListview')
              : List13PropertyListviewWidget(),
        ),
        FFRoute(
          name: 'profile',
          path: '/profile',
        ...
        FFRoute(
          ...
          path: '/addProduct',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'addProduct')
              : AddProductWidget(),
        ),
        FFRoute(
          name: 'productDetails',
        ...
        FFRoute(
          name: 'filterSearch',
          path: '/filterSearch',
          builder: (context, params) => FilterSearchWidget(),
        ),
        FFRoute(
          name: 'insideChat',
          path: '/insideChat',
          ...
          builder: (context, params) => InsideChatWidget(
            chats: params.getParam(
                'chats', ParamType.DocumentReference, false, ['chats']),
