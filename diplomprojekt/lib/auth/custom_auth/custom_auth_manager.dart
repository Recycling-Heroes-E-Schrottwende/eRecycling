...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    diplomprojektAuthUserSubject.add(
      DiplomprojektAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<DiplomprojektAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  DiplomprojektAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = DiplomprojektAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    diplomprojektAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
DiplomprojektAuthUser? currentUser;
